...
resource "aws_api_gateway_integration" "synapsewear" {
  ...
  depends_on = [aws_api_gateway_method.synapsewear]
}
...
resource "aws_api_gateway_integration_response" "synapsewear_200" {
  ...
  depends_on = [aws_api_gateway_integration.synapsewear]
}
...
data "template_file" "synapsewear_apigw_request_template_application-json" {
  template = file(
    "${path.module}/templates/synapsewear_apigw_request_template_application-json.tmpl",
  )
...
data "template_file" "synapsewear_apigw_request_template_application-x-www-form-urlencoded" {
  template = file(
    "${path.module}/templates/synapsewear_apigw_request_template_application-x-www-form-urlencoded.tmpl",
  )
